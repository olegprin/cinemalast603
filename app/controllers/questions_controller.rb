class QuestionsController < ApplicationController
  ...
  def create
    @post=Post.find(params[:post_id])
     ...
     @question =  @post.questions.build(question_params)
  ...
  def destroy
    @question.destroy
    respond_to do |format|
      format.html { redirect_to posts_path, notice: 'Question was successfully destroyed.' }
  ...
  private
    ...
    def question_params
      params.require(:question).permit({:answers_attributes=> [:id, :answer, :_destroy]}, :question)
