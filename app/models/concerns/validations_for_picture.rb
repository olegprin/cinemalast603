...
#set up "uploaded_file" field as attached_file (using Paperclip) 
  has_attached_file  @model_of_attachment, styles: {for_posting: "340x340>", small: "300x300>",thumb: "300x300>",thumb: "300x300#",preview: "360x360>",preview: "360x360#" }, :path => ":rails_root/public/image/:attachment/:id/:basename_:style.:extension",
